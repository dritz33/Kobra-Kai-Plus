...
#define DEVICE_NAME             "Kobra Kai +"
//#define FIRMWARE_VER            "Marlin V2.0.8.1"
#if ENABLED(CLASSIC_JERK)
#define FIRMWARE_VER            "Kobra Kai + 2.0.0CJ"
#if ENABLED(LIN_ADVANCE)
#define FIRMWARE_VER            "Kobra Kai + 2.0.0LACJ"
#else
#define FIRMWARE_VER            "Kobra Kai + 2.0.0CJ"
#endif
#else
#if ENABLED(LIN_ADVANCE)
#define FIRMWARE_VER            "Kobra Kai + 2.0.0LAJD"
#else
#define FIRMWARE_VER            "Kobra Kai + 2.0.0JD"
#endif
#endif
